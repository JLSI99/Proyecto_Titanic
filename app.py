...
# ==========================================
# 2. CSS PERSONALIZADO (CENTRADO REAL)
# ==========================================
st.markdown("""
    <style>
...
# ==========================================
st.markdown(
    "<h1>🚢 Simulación de Jani: Titanic</h1>",
    unsafe_allow_html=True
)
...
with col_centro:
    ...
    if assets is None:
        ...
        st.error(
            "⚠️ No se encontró 'modelo_titanic.pkl'. "
            "Por favor, súbelo al repositorio."
        )
        ...
        if st.session_state.paso == 1:
            ...
            if st.button("Siguiente ➡️"):
                ...
                if nombre:
                    ...
                    st.warning(
                        "Necesitamos un nombre para el manifiesto."
                    )
        ...
        # ==========================================
            ...
            st.subheader(
                f"Hola {st.session_state.datos['nombre']}, "
                "¿en qué clase viajas?"
            )
            ...
            clase = st.selectbox(
                ...
                f"Clase {x} - {'Lujo' if x == 1 else 'Económica'}"
            )
        ...
        # ==========================================
            ...
            if st.button("Siguiente ➡️"):
                ...
                st.session_state.datos['es_hombre'] = (
                    1 if sexo == "Hombre" else 0
                )
        ...
        # ==========================================
            ...
            fare = st.number_input(
                "Precio del Ticket (en Libras de 1912):",
                0.0,
                512.0,
                32.0
            )
        ...
        # ==========================================
            ...
            # Escalado
            input_scaled = assets['escalador'].transform(
                input_df
            )

            # Predicción
            prob = assets['modelo'].predict_proba(
                input_scaled
            )[0][1]

            st.subheader(
                f"Resultado para {d['nombre']}"
            )
            ...
            if prob > 0.5:
                ...
                st.success(
                    "✨ ¡SOBREVIVISTE! "
                    "Lograste llegar a un bote salvavidas."
                )

            else:

                st.error(
                    "❄️ EL DESTINO NO FUE FAVORABLE. "
                    "Te has hundido con el Titanic."
                )
